...
class StructuredLogger implements Logger {
  ...
  constructor(serviceName: string = 'mcp-filesystem') {
  ...
  private formatLogEntry(level: LogEntry['level'], message: string, args?: any[], error?: any): LogEntry {
    return {
  ...
  private log(level: LogEntry['level'], message: string, args?: any[], error?: any): void {
