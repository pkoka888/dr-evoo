...
### **Mandatory Workflow: Conductor**
All feature development and bug fixes must follow the **Context -> Spec & Plan -> Implement** lifecycle managed by the **Conductor** extension.
1.  **Context Loading**: Before starting, read the `conductor/index.md` and its referenced specs.
2.  **Implementation**: Track progress in `conductor/tracks/<id>/plan.md`.
3.  **Completion**: Verify against `conductor/workflow.md` Definition of Done.
